...
const transactions = [
  ...
  ["txn_contract", "account_checking", "demo-contract", "2026-07-11", -90000, "COLLABORATOR PAYMENT", "Contractor", "cat_other_income", "want", "entity_business", null, "tax_contract_labor", 100, 0, 0, null, "user", 100, 1],
